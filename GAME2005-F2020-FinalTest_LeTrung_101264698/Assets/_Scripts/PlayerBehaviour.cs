...
public class PlayerBehaviour : MonoBehaviour
{
    ...
    private void _Move()
    {
        ...
        //if (isGrounded)
        {
            ...
            body.velocity = new Vector3(body.velocity.x, body.velocity.y, body.velocity.z); // remove y
            

            if (Input.GetAxisRaw("Jump") > 0.0f)
            {
                body.velocity = transform.up * speed * 0.1f * Time.deltaTime;
                //body.velocity = new Vector3(body.velocity.x, transform.up.y * speed * 0.1f * Time.deltaTime, body.velocity.z);
            }
